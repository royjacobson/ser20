...
if not defined APPVEYOR (
    ...
    @echo I sincerely recommend not using it for building/testing ser20 locally.
    exit /b 0
)
...
if "%~1" == "test" (
    ...
    @rem   Ser20 uses Boost Unit test framework. Rather than modifying the code to load boost test
