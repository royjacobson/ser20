...
#ifndef SER20_RAPIDJSON_ISTREAMWRAPPER_H_
#define SER20_RAPIDJSON_ISTREAMWRAPPER_H_
...
SER20_RAPIDJSON_DIAG_PUSH
SER20_RAPIDJSON_DIAG_OFF(4351) // new behavior: elements of array 'array' will be default initialized
#endif
...
public:
    ...
    */
    BasicIStreamWrapper(StreamType &stream, char* buffer, size_t bufferSize) : stream_(stream), buffer_(buffer), bufferSize_(bufferSize), bufferLast_(0), current_(buffer_), readCount_(0), count_(0), eof_(false) { 
        SER20_RAPIDJSON_ASSERT(bufferSize >= 4);
        Read();
    }
...
#endif // SER20_RAPIDJSON_ISTREAMWRAPPER_H_
